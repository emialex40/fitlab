...
<body>
	...
	<header class="header">
		<div class="wrp">
			...
			<ul class="header_menu" id="h_menu">
				<li><a class="tlink" href="#personal">Персональные<br>тренировки</a></li>
				<li><a class="tlink" href="#classic">Тренажерный<br>зал</a></li>
				<li><a class="tlink" href="#classic">Занятия<br>в мини-группах</a></li>
			</ul>
			...
			<div class="personal_list">
				...
				<ul class="personal_list-line clearfix">
					<li class="personal_list-4">
						<div class="personal_list-line_title">Программа питания</div>
			...
			<form class="js-form">
				<div class="online_form clearfix">
					<div class="online_form-row">
						<input class="input-2" type="text" name="name" placeholder="Имя">
					</div>	
					<div class="online_form-row">
				...
				<div class="species_list clearfix">
					<div class="species_list-item">
						...
						<div id="text-1" class="popup hide-content">
							...
							<div class="popup_form">
								<div class="popup_form-title">Узнать больше о персональных тренировках в тренажёрном зале.</div>
								<form class="js-form">
					...
					<div class="species_list-item">
						...
						<div id="text-2" class="popup hide-content">
							...
							<div class="popup_form">
								<div class="popup_form-title">Узнать больше о персональных тренировках на тренажёрах пилатес     </div>
								<form class="js-form">
									<div class="popup_form-row">
										<input class="input-2" type="text" name="name" placeholder="Имя">
									</div>	
					...
					<div class="species_list-item">
						...
						<div id="text-4" class="popup hide-content">
							...
							<div class="popup_form">
								<div class="popup_form-title">Узнать больше о персональных тренировках по функциональному тренингу.</div>
								<form class="js-form">
									<div class="popup_form-row">
										<input class="input-2" type="text" name="name" placeholder="Имя">
									</div>	
					...
					<div class="species_list-item">
						...
						<div id="text-3" class="popup hide-content">
							...
							<div class="popup_form">
								<div class="popup_form-title">Записаться на пробную тренировку в малой группе</div>
								<form class="js-form">
									<div class="popup_form-row">
										<input class="input-2" type="text" name="name" placeholder="Имя">
									</div>	
		...
		<div class="wrp">	
			<div class="classic_list-box">
				<div class="classic_list clearfix">
					<div class="classic_list-first">
						<h2 class="classic-title">Классический фитнес</h2>
						<div class="classic-text">
							<p>Для профессионалов и любителей фитнеса в нашем клубе оборудованы просторный тренажерный зал, залы групповых занятий, студия пилатеса.
                                В тренажерном зале организовано несколько тренировочных зон: кардиозона, зона свободных весов, зона функционального тренинга, зона растяжки.</p>

							<p>Занимайтесь самостоятельно или в сопровождении тренера - индивидуально или в паре. Групповые занятия  проводятся в минигруппах 5-8 человек.</p>
						</div>
					</div>
					<div class="classic_list-item">
						...
						<div class="classic_list-info">
							...
							<div id="text-5" class="popup hide-content">
								...
								<div class="popup_form">
									<div class="popup_form-title">Записаться на пробную тренировку в тренажерном зале</div>
									<form class="js-form">
										<div class="popup_form-row">
											<input class="input-2" type="text" name="name" placeholder="Имя">
										</div>	
					...
					<div class="classic_list-item">
						...
						<div class="classic_list-info">
							...
							<div id="text-6" class="popup hide-content">
								...
								<div class="popup_form">
									<div class="popup_form-title">Записаться на пробную тренировку в тренажёрном зале</div>
									<form class="js-form">
										<div class="popup_form-row">
											<input class="input-2" type="text" name="name" placeholder="Имя">
										</div>	
					...
					<div class="classic_list-item">
						...
						<div class="classic_list-info">
							...
							<div id="text-7" class="popup hide-content">
								...
								<div class="popup_form">
									<div class="popup_form-title">Записаться на пробную тренировку</div>
									<form class="js-form">
										<div class="popup_form-row">
											<input class="input-2" type="text" name="name" placeholder="Имя">
										</div>	
					...
					<div class="classic_list-item">
						...
						<div class="classic_list-info">
							...
							<div id="text-8" class="popup hide-content">
								...
								<div class="popup_form">
									<div class="popup_form-title">ПОСЕТИТЬ ПРОБНУЮ ТРЕНИРОВКУ</div>
									<form class="js-form">
										<div class="popup_form-row">
											<input class="input-2" type="text" name="name" placeholder="Имя">
										</div>	
	...
	<div class="advantages">
		<div class="wrp">			
			...
			<div class="advantages_list">
				<div class="advantages_row clearfix">
	...
	<footer class="footer">
		<div class="wrp">
			...
			<div class="footer_online">
				<div class="footer_online-title">ОСТАЛИСЬ ВОПРОСЫ?<!--<br>на персональную<br>тренировку:--></div>
				<div class="footer_online-text">Мы свяжемся с вами в ближайшее время<!--<br>клубная карта в подарок!--></div>
				<form class="js-form">
