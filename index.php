...
//	}
	...
	if (empty($error)) {
		...
		$email_headers = array(
			...
			'form13' => 'Записаться на тренировку - Алексей Фёдоров',
			'form14' => 'ЗАПИСАТЬСЯ НА ПРОСМОТР КЛУБА',
			'form15' => 'Мы свяжемся с вами в ближайшее время',
			'form16' => 'Записаться на тренировку - Павла Федорова',
			'form17' => 'Записаться на тренировку - Оксана Ракитянская',
			'form18' => 'Записаться на тренировку - Виктория Лилл',
			'form19' => 'Записаться на тренировку - Максим Литвинов',
			'form20' => 'Записаться на тренировку - Юрий Конахович'
		);
